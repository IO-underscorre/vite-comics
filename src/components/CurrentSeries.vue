<script>
import ComicSerie from './ComicSerie.vue';
...
<template>
    <section class="current-series">
        <div class="content-box">
            ...
            <ul>
                <li v-for="(comic, index) in comicsList" :key="index">
                    <ComicSerie :comicTitle="comic.series" :comicImgLink="comic.thumb" />
                </li>
            </ul>
        </div>
    </section>
